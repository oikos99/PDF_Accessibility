...
deploy_backend_solution() {
    ...
    if [ "$DEPLOYMENT_TYPE" == "pdf2html" ]; then
        ...
        ENV_VARS="[
            ...
            {\"name\": \"TAGGING_ENGINE\", \"value\": \"${TAGGING_ENGINE:-opendataloader}\"}, {\"name\": \"OCR_MODE\", \"value\": \"${OCR_MODE:-auto}\"}, {\"name\": \"OCR_TEXT_THRESHOLD\", \"value\": \"${OCR_TEXT_THRESHOLD:-20}\"}, {\"name\": \"OCR_LANGUAGE\", \"value\": \"${OCR_LANGUAGE:-eng}\"}, {\"name\": \"OCR_ON_FAILURE\", \"value\": \"${OCR_ON_FAILURE:-fail}\"}, {\"name\": \"ODL_HYBRID\", \"value\": \"${ODL_HYBRID:-off}\"}, {\"name\": \"ODL_HYBRID_MODE\", \"value\": \"${ODL_HYBRID_MODE:-auto}\"}, {\"name\": \"ODL_HYBRID_FALLBACK\", \"value\": \"${ODL_HYBRID_FALLBACK:-true}\"}, {\"name\": \"ODL_HYBRID_TIMEOUT_MS\", \"value\": \"${ODL_HYBRID_TIMEOUT_MS:-60000}\"}, {\"name\": \"ODL_HYBRID_START_SERVER\", \"value\": \"${ODL_HYBRID_START_SERVER:-true}\"}, {\"name\": \"ODL_HYBRID_PORT\", \"value\": \"${ODL_HYBRID_PORT:-5002}\"}, {\"name\": \"ODL_HYBRID_STARTUP_TIMEOUT\", \"value\": \"${ODL_HYBRID_STARTUP_TIMEOUT:-120}\"}, {\"name\": \"ODL_TABLE_METHOD\", \"value\": \"${ODL_TABLE_METHOD:-}\"}, {\"name\": \"ODL_INCLUDE_HEADER_FOOTER\", \"value\": \"${ODL_INCLUDE_HEADER_FOOTER:-false}\"}, {\"name\": \"ODL_TASK_MEMORY_MIB\", \"value\": \"${ODL_TASK_MEMORY_MIB:-4096}\"}, {\"name\": \"ODL_TASK_CPU\", \"value\": \"${ODL_TASK_CPU:-1024}\"}, {\"name\": \"OCR_BAD_TEXT_ACTION\", \"value\": \"${OCR_BAD_TEXT_ACTION:-redo}\"}, {\"name\": \"OCR_BAD_TEXT_THRESHOLD\", \"value\": \"${OCR_BAD_TEXT_THRESHOLD:-0.08}\"}, {\"name\": \"OCR_FORCE_FALLBACK\", \"value\": \"${OCR_FORCE_FALLBACK:-true}\"}, {\"name\": \"OCR_FORCE_FALLBACK_ON_BAD_TEXT\", \"value\": \"${OCR_FORCE_FALLBACK_ON_BAD_TEXT:-true}\"}, {\"name\": \"DOCUMENT_LANGUAGE_MODE\", \"value\": \"${DOCUMENT_LANGUAGE_MODE:-auto}\"}, {\"name\": \"DOCUMENT_LANGUAGE_OVERRIDE\", \"value\": \"${DOCUMENT_LANGUAGE_OVERRIDE:-}\"}, {\"name\": \"DOCUMENT_LANGUAGE_CONFIDENCE_THRESHOLD\", \"value\": \"${DOCUMENT_LANGUAGE_CONFIDENCE_THRESHOLD:-0.75}\"}, {\"name\": \"DOCUMENT_LANGUAGE_USE_BEDROCK\", \"value\": \"${DOCUMENT_LANGUAGE_USE_BEDROCK:-true}\"}, {\"name\": \"DOCUMENT_LANGUAGE_MODEL\", \"value\": \"${DOCUMENT_LANGUAGE_MODEL:-us.amazon.nova-lite-v1:0}\"}, {\"name\": \"FINALIZER_SET_TABS\", \"value\": \"${FINALIZER_SET_TABS:-true}\"}, {\"name\": \"PDF_TAB_ORDER\", \"value\": \"${PDF_TAB_ORDER:-S}\"}, {\"name\": \"AI_IMAGE_REVIEW_MODE\", \"value\": \"${AI_IMAGE_REVIEW_MODE:-apply}\"}, {\"name\": \"AI_IMAGE_REVIEW_MODEL\", \"value\": \"${AI_IMAGE_REVIEW_MODEL:-us.amazon.nova-lite-v1:0}\"}, {\"name\": \"AI_IMAGE_REVIEW_MAX_IMAGES\", \"value\": \"${AI_IMAGE_REVIEW_MAX_IMAGES:-8}\"}, {\"name\": \"AI_IMAGE_APPLY_MIN_CONFIDENCE\", \"value\": \"${AI_IMAGE_APPLY_MIN_CONFIDENCE:-0.60}\"}
        ]"
    fi
